using CatalogoProdutos.Shared.Domain.Interfaces.Services.Model;
using CatalogoProdutos.Shared.Domain.Interfaces.Repositories.Model;

namespace CatalogoProdutos.Shared.Domain.Services.Base;

public abstract class BaseService<T>(IModelRepository<T> repository)
    : IModelService<T> where T : class
{
    private readonly IModelRepository<T> _repository = repository;
